...
function INIT_ENGINE() {
    ...
    if (typeof exports === 'object' && typeof module === 'object')
        ...
        exports["Stockfish_14"] = Stockfish;
    return Stockfish;
}
    ...
    (function ()
    {
        ...
        if (isNode) {
            ...
            if (require.main === module) {
                ...
                Stockfish_14 = INIT_ENGINE();
                Stockfish_14(mod).then(function (sf)
                {
                    myEngine = sf;
            ...
            Stockfish_14 = INIT_ENGINE();
            Stockfish_14(mod).then(function onCreate(sf)
            {
                myEngine = sf;
